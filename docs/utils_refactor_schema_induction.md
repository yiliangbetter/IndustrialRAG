...
对 7 份手册重跑 coalesce，逐份对比金标准：

| 手册 | 允许差异 |
|---|---|
| 高速智能封边机 | **逐字节不变**（归纳结果与原 hardcode 等价） |
| 双端/自动/高速自动封边机、PC报警 | **逐字节不变**（schema=None 路径） |
| 加工中心、数控六面钻 | **仅允许**"操作步骤参与 step-closed/切分"引起的段落重组；逐处人工审阅 |

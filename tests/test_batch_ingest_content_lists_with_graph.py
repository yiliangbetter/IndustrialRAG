...
def test_main_raises_system_exit_with_async_main_return_value(biclg, monkeypatch):
    async def fake_async_main():
        return 43

    monkeypatch.setattr(biclg, "async_main", fake_async_main)
...
@pytest.mark.asyncio
async def test_async_main_returns_1_when_ingest_raises(biclg, monkeypatch, tmp_path):

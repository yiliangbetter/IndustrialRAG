"""Regression tests for merge_nodes_and_edges storage kwargs (PR #250 / issue #241).

Omitting entity_chunks_storage / relation_chunks_storage silently drops chunk
provenance during multimodal graph merges. These tests assert both the processor
batch-merge path and the modalprocessor non-batch path forward the storages.
"""

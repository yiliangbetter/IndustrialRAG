"""Regression tests for system_prompt forwarding on multimodal queries.

Silent regressions here would drop auditor/compliance prompts or cache answers
under keys that ignore the prompt, mixing incompatible responses.
"""

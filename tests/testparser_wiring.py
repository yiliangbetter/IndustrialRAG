...
@pytest.mark.asyncio
async def test_parse_document_office_forwards_parse_method(monkeypatch, tmp_path):
    import raganything.processor as processor_module
    ...
    await dummy.parse_document(str(fake_docx), parse_method="ocr", method="txt")

    assert captured_kwargs["method"] == "ocr"

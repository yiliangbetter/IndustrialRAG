...
from .ingest_coalesce import (  # noqa: F401
    ...
    _is_orphan_maintenance_field_segment,
    _is_orphan_maintenance_metadata_only_segment,
    _is_thin_section_lead_segment,
    _lookahead_pair_text_image_segments,
    _maintenance_field_prefix,
    _maintenance_section_step_closed,
    _maintenance_step_alignment,
    _merge_orphan_heading_segments,
    _merge_orphan_maintenance_metadata_segments,

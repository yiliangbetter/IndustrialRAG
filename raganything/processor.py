...
class ProcessorMixin:
    ...
    def _extract_text_and_multimodal(
        self, content_list: List[Any]
    ) -> Tuple[List[Dict[str, Any]], str, List[Dict[str, Any]]]:
        """Normalize MinerU v2 wrappers and recover text from block-style payloads."""
    ...
    async def parse_document(
        ...
        **kwargs,
        ...
        # Generate doc_id from normalized blocks so nested MinerU v2 wrappers
        ...
        **kwargs,
        ...
        try:
            ...
            (
                ...
                text_content,
                multimodal_items,
            ) = self._extract_text_and_multimodal(content_list)
